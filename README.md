...
- [**Автоматический AI-ассистент для анализа резюме**](https://github.com/VladimirMenshikov/Automatic-AI-Assistant-for-Resume-Analysis/blob/main/README.md)
  - AI-ассистент автоматизирует процесс анализа резюме, используя современные технологии искусственного интеллекта для мгновенного и точного сопоставления резюме с открытыми вакансиями.
- [**Умный чат-консультант на сайте для бизнеса**](https://github.com/VladimirMenshikov/AI-assistant-chat-on-site/blob/main/README.md)
   - ИИ-ассистент работает круглосуточно, консультирует ваших клиентов и квалифицирует лиды без вашего участия
